...
$(document).ready(function () {
  ...
  */
  ...
  var BASE_API = 'https://api.dev.covid19-carso.com/';
  /*  Variables */
  ...
  var imagesFAQ = ['cubrebocas1.jpg', 'signos_de_alarma.jpg', 'personas_mayores.jpg', 'prevencion_en_el_hogar.jpg', 'si_me_cuido.jpg', 'medidas_generales_de_prevencion.jpg', 'no_mano_no_abrazo_no_beso_no_contagio.jpg', 'medidas_generales_de_prevencion_empleados.jpg', 'limpieza_de_celular-01.jpg', 'lavado_de_manos-01.jpg', // 'lavado_de_manos-02.jpg',
  // 'lavado_de_manos-03.jpg',
  // 'lavado_de_manos-04.jpg',
  // 'lavado_de_manos-05.jpg',
  // 'lavado_de_manos-06.jpg',
  'elevador.jpg', 'diagnostico_confirmado.jpg', 'cuidados_generales_para_personas_enfermas.jpg'];
  var urlDownloadApp = 'download/monitoreo_V5.apk';

  var addImagesFAQs = function addImagesFAQs() {
    var imag = 0;

    while (imag < imagesFAQ.length) {
      $('.imagesFAQs').append('<div class=\"imageInfo\"><img src=\"img\/faqs\/' + imagesFAQ[imag] + '\" alt=\"' + imagesFAQ[imag] + '"\/><\/div>'); //$('.imagesFAQs').append('<p>'+imagesFAQs.imgFaq+'</p>')
  ...
  var showCoord = function showCoord() {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var errores = {
        ...
        3: 'Expiró el tiempo de respuesta'
      };
  ...
  var clickGeo = function clickGeo() {};

  var request202 = function request202() {
    addLoader('false');
    console.log('Send  success...');
  };

  var request401 = function request401() {
    addLoader('false');
  ...
  var request404 = function request404() {
    addLoader('false');
    console.log('Page no found...');
  };

  var request440 = function request440() {
    addLoader('false');
  ...
  var request500 = function request500() {
    addLoader('false');
  ...
  var closeModalsC = function closeModalsC() {
    $('.notificationAlert').remove();
  };

  var closeModalResult = function closeModalResult() {
    $('.modalResult').fadeOut();
    $(".tooltipOpener").removeClass("active");
  };

  var openModalResult = function openModalResult(e) {
    e.preventDefault();
    $('.modalResult').fadeIn();
  };
  ...
  var logOutPortal = function logOutPortal(type) {
  ...
  var tooltipOpen = function tooltipOpen() {
    $(".tooltipOpener").toggleClass("active");
  };
  /* Prellenado de datos */


  var dataUserCharge = function dataUserCharge() {
  ...
  var dataSimptomsCharge = function dataSimptomsCharge() {
    var dataUserCont = getStorage64('dataUserCont');
    ...
    if (dataDiseasesCont != 'null') {
      if (simptomsList.length != 0) {
        ...
        while (_i < simptomsList.length) {
          $('.myClinicalCards .simptomsList').append('<li>' + simptomsList[_i].nombre + '<\/li>');
          _i++;
        }
      }
    } else {
      $('.myClinicalCards .simptomsList').append('<li>Ninguno<\/li>');
    } // console.log(dataUserCont)
  ...
  var preChargeIMCData = function preChargeIMCData() {
    var dataImcCont = getStorage64('dataImcCont');
    var peso;
  ...
  var preChargeSimptompsData = function preChargeSimptompsData() {
    //debugger
    //axiosListDiseases()
    var dataUserCont = getStorage64('dataUserCont');
    var sexUser = dataUserCont.sexo.toUpperCase();
    var dataDiseasesCont = getStorage64('dataDiseasesCont');
    var simptomsList = dataDiseasesCont.enfermedades; //console.log(dataDiseasesCont)
    ...
    if (dataDiseasesCont != 'null') {
      ...
      if (simptomsList.length === 1) {
        ...
        while (_i2 < simptomsList.length) {
          if (simptomsList[_i2].id != 10) {
            $('[name="diseases_' + simptomsList[_i2].id + '"]').trigger('click');
            $('[name="pregnantReg"]:eq(1)').trigger('click');
          } else if (simptomsList[_i2].id === 10) {
            $('[name="pregnantReg"]:eq(0)').trigger('click');
          }
  ...
  var updateIMC = function updateIMC() {
    var valInputImcPesoReg = $('[name="imcPesoReg"]').val();
    var valInputImcAlturaReg = $('[name="imcAlturaReg"]').val();
  ...
  var updateCompany = function updateCompany() {
    var valInputEmpresa = $('[name="selecEmpresaReg"]').val();
    var valInputArea = $('[name="selecAreaReg"]').val();
  ...
  var updateSimptomps = function updateSimptomps() {
    //debugger
    var dataUserCont = getStorage64('dataUserCont');
    var valInputPregnant = $('.pregnantType [name="pregnantReg"]:checked').val();
    var valInputPregnantValidate = $('.pregnantType [name="pregnantReg"]:checked').length;
    var valInputDiseases = $('.arrayDiseases [type="checkbox"]:checked').length;
    var sexUser = dataUserCont.sexo.toUpperCase();
    var dataRegistryDiseases = getStorage64('arrayDiseases');
  ...
  var validateEmptySimptomps = function validateEmptySimptomps() {
    //debugger
  ...
  var succesUpdateSimp = function succesUpdateSimp() {
    ...
    if (window.location.pathname.indexOf('/clinicalProfile') !== -1) {
      ...
      if (dataDiseasesCont != 'null') {
        if (simptomsList.length != 0) {
          ...
          while (_i3 < simptomsList.length) {
            $('.myClinicalCards .simptomsList').append('<li>' + simptomsList[_i3].nombre + '<\/li>');
            _i3++;
          }
        }
      } else {
  ...
  var succesUpdateImc = function succesUpdateImc() {
    console.log('charge success'); //debugger
  ...
  var succesUpdateInfoGral = function succesUpdateInfoGral() {
  ...
  var succesUpdateCompany = function succesUpdateCompany() {
    var dataCompanyCont = getStorage64('dataCompanyCont');
  ...
  var validateFoat = function validateFoat(_float) {
    var re = /^[+-]?\d+(\.\d+)?$/;
    return re.test(_float);
  };
  ...
  var validatteDate = function validatteDate(date) {
    var re = /[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])/ig;
    return re.test(date);
  };

  var stripCode = function stripCode(code) {
    var originalCode = code;
    var codeStrip = originalCode.replace(/(<([^>]+)>)/ig, "");
    return codeStrip;
  };

  var validateTypeDate = function validateTypeDate(code) {
    var re = /^[0-9\/-]*$/;
    return re.test(code);
  };

  var returnFormatDate = function returnFormatDate(dateValue) {
    var fecha = String(dateValue);
    var dateCount = fecha.length;
    var dateNormal = fecha.indexOf('-') >= 1;
    var dateSafari = fecha.indexOf('/') >= 1;
    ...
    if (dateCount !== 10) {
      ...
      if (_fechaArray[0].length == 4) {
        _fechaArreglada = _fechaArray[0] + '-' + _fechaArray[1] + '-' + _fechaArray[2];
        return _fechaArreglada;
      } else if (_fechaArray[0].length == 2) {
        _fechaArreglada = _fechaArray[2] + '-' + _fechaArray[1] + '-' + _fechaArray[0];
        return _fechaArreglada;
      }
    }
  };

  var returnFormatDateSub = function returnFormatDateSub(dateValue) {
    var fecha = String(dateValue);
    var dateCount = fecha.length;
    var dateNormal = fecha.indexOf('-') >= 1;
    var dateSafari = fecha.indexOf('/') >= 1;
    ...
    if (dateCount !== 10) {
      ...
      var _fechaArray2 = fecha.split('/');

      var _fechaArreglada2;

      if (_fechaArray2[0].length == 4) {
        _fechaArreglada2 = _fechaArray2[2] + '-' + _fechaArray2[1] + '-' + _fechaArray2[0];
        return _fechaArreglada2;
      } else if (_fechaArray2[0].length == 2) {
        _fechaArreglada2 = _fechaArray2[0] + '-' + _fechaArray2[1] + '-' + _fechaArray2[2];
        return _fechaArreglada2;
      }
    }
  };
  ...
  var dateMinBirthady = function () {
    var hoy = new Date();
    var dd = hoy.getDate(); //var mm = hoy.getMonth()+1;
  ...
  var calculateIMC = function calculateIMC(peso, altura) {
    var imc = peso / Math.pow(altura, 2);
    var valRound = imc * 10000;
    imcTotal = [];
    imcTotal.push(valRound.toFixed(2));

    if (imcTotal[0] < 18.5) {
      imcTotal.push('Peso insuficiente');
    }

    if (imcTotal[0] >= 18.6 && imcTotal[0] <= 24.9) {
      imcTotal.push('Peso normal');
    }

    if (imcTotal[0] >= 25 && imcTotal[0] <= 26.9) {
      imcTotal.push('Sobrepeso grado I');
    }

    if (imcTotal[0] >= 27 && imcTotal[0] <= 29.9) {
      imcTotal.push('Sobrepeso grado II (preobesidad)');
    }

    if (imcTotal[0] >= 30 && imcTotal[0] <= 34.9) {
      imcTotal.push('Obesidad de tipo I');
    }

    if (imcTotal[0] >= 35 && imcTotal[0] <= 39.9) {
      imcTotal.push('Obesidad de tipo II');
    }

    if (imcTotal[0] >= 40 && imcTotal[0] <= 49.9) {
      imcTotal.push('Obesidad de tipo III (mórbida)');
    }

    if (imcTotal[0] >= 50) {
      imcTotal.push('Obesidad de tipo IV (extrema)');
    }
  ...
  var addModal = function addModal(message) {
  ...
  var addLoader = function addLoader(active) {
  ...
  var splashAndroid = function splashAndroid() {
  ...
  var upTop = function upTop(param) {
    $(document).scrollTop(0);
  };

  var upErrorMessage = function upErrorMessage() {
    var topError = $('.error').offset().top - 30;
    $(document).scrollTop(topError);
  };
  /* Funciones del storage */


  var setStorage64 = function setStorage64(key, value) {
  ...
  var getStorage64 = function getStorage64(key) {
  ...
  var deleteStorage64 = function deleteStorage64(key) {
    var llave = JSON.stringify(key);
    var keyString = btoa(llave);
  ...
  var sessionUserActive = function sessionUserActive(destruct) {
  ...
  var setCodeEnter = function setCodeEnter(param) {
  ...
  var getCodeEnter = function getCodeEnter() {
  ...
  var setSusumu = function setSusumu() {
  ...
  var getSusumu = function getSusumu() {
  ...
  var setIdRedis = function setIdRedis(param) {
    localStorage.setItem('tokunRedis', btoa(param));
    return tokunRedis;
  };

  var getIdRedis = function getIdRedis() {
  ...
  var validatePProtect = function validatePProtect() {
    getCodeEnter();
    var valInput = $('.passwordProtect input').val();
  ...
  var validateLoginAPP = function validateLoginAPP(data) {
    if (data === undefined) {
  ...
  var validateLogin = function validateLogin() {
    var valInputEmail = $('[name="emailLogin"]').val();
    var valInputPass = $('[name="passwordLogin"]').val();
    var dataLogin = {
      "email": valInputEmail,
  ...
  var showRegistry = function showRegistry() {
    $('.formRecord').removeClass('hidden');
    $('.formLogin').addClass('hidden');
    $('.formQuestion').addClass('hidden');
  };

  var validateRecoveryPass = function validateRecoveryPass() {
    var valInput = $('[name="recoveryPassword"]').val();
    var dataRecoveryPass = {
      "email": valInput
    };
  ...
  var validateUpdatePass = function validateUpdatePass() {
    var valInputUp = String($('[name="updatePassword"]').val());
    var valInputRec = String($('[name="confirmUpPass"]').val());
    var token = getStorage64('getTokenR');
    var upadtePass = {
  ...
  var validateGenere = function () {
    if ($('.registryModule, .registryFamilyModule').length === 1) {
      generoLS = getStorage64('registryGender'); //console.log('LS: '+generoLS)
      ...
      $('body').on('change', '.genereType', function () {
        var genero = $('.genereType [name="genderReg"]:checked').val(); //console.log('change: '+genero)
      ...
      $('body').on('change', '.arrayDiseases input, .pregnantType input', function () {
        ...
        if ($this.attr('name') === 'ninguna') {
          ...
          if ($this.parent().parent().hasClass('arrayDiseases')) {
            ...
            setStorage64('arrayDiseases', source); // console.log( '------2------')
            // console.log( getStorage64('arrayDiseases') )
            ...
            setStorage64('arrayDiseases', source); //console.log( '------3------')
            //console.log( getStorage64('arrayDiseases') )
    ...
    if ($('.monitoringModule').length === 1) {
      ...
      $('body').on('change', '.arraySymptoms input', function () {
        ...
        if ($this.attr('name') === 'sintomaNinguna') {
          ...
          source = [];
          setStorage64('arraySymptoms', source);
          setStorage64('sintomaNinguna', 'true'); //console.log('asdT'+getStorage64('sintomaNinguna'))
          ...
          setStorage64('arraySymptoms', source);
          setStorage64('sintomaNinguna', 'false'); //console.log('asdasdF'+getStorage64('sintomaNinguna'))
  ...
  var validateDateSymptoms = function validateDateSymptoms() {
  ...
  var sendFamilyData = function sendFamilyData() {
    addLoader('false');
    upTop();
  ...
  var sendUserFamilyData = function sendUserFamilyData() {
    addLoader('false');
    upTop();
  ...
  var sendDiseasesData = function sendDiseasesData() {
    addLoader('false');
    upTop();
  ...
  var updateDiseasesData = function updateDiseasesData() {
  ...
  var sendIMCData = function sendIMCData() {
    addLoader('false');
    upTop();
  ...
  var updateIMCData = function updateIMCData() {
    setTimeout(function () {
      upTop();
      addLoader('false');
      redirectUrl('clinicalProfile');
  ...
  var sendCompanyData = function sendCompanyData() {
    addLoader('false');
    request202();
    location.href = 'monitoring.html';
  };

  var emaiInUse = function emaiInUse() {
  ...
  var sessionTimeOut = function sessionTimeOut() {
    toast(warningMessages[10]); //toast('Tu sesión ha expirado.')
  };

  var sintomasSuccess = function sintomasSuccess() {
    addLoader('false');
    upupTop();
    request202();
  ...
  var errorInputNotify = function errorInputNotify(name, text) {
    $('[name="' + name + '"]').addClass('error');
    $('[name="' + name + '"] + .errorMessage').text(text);
    upErrorMessage();
  };

  var errorRadioNotify = function errorRadioNotify(name, text) {
    $('.' + name).addClass('error');
    $('.' + name + ' + .errorMessage').text(text);
    upErrorMessage();
  };

  var errorSelectNotify = function errorSelectNotify(name, text) {
    $('[name="' + name + '"]').parent().addClass('error');
    $('[name="' + name + '"]').parent().next().text(text);
    upErrorMessage();
  };

  var validateAccessFamily = function validateAccessFamily() {
    var valInputId = $('[name="idSeguimiento"]').val();
    var valInputEmail = $('[name="emailFamily"]').val();
    var valInputRelation = $('[name="familyRelationship"]').val();
    var valInputFamilar = $('.familiarType [name="familiarReg"]:checked').val();
    var valInputFamiliarValidate = $('.familiarType input:radio[name="familiarReg"]:checked').length;
    var loginIn = getStorage64('userLoginSession');
    var dataValidateFamily = {
      "email": valInputEmail,
  ...
  var validateRegistryFormFirst = function validateRegistryFormFirst() {
    var familiar_ID = getStorage64('userRedisParentT'); //console.log('familiar token: '+familiar_ID)

    var valInputId = $('[name="idEmpleadoReg"]').val();
    var valInputEmail = $('[name="emailReg"]').val();
    var valInputPass = $('[name="passwordReg"]').val();
    var valInputName = $('[name="nombreReg"]').val();
    var valInputPaternal = $('[name="apelldoPaternoReg"]').val();
    var valInputMaternal = $('[name="apellidoMaternoReg"]').val();
    var valInputCP = $('[name="codigoPostalReg"]').val();
    ...
    var valInputGender = $('.genereType [name="genderReg"]:checked').val();
    var valInputGenderValidate = $('.genereType [name="genderReg"]:checked').length;
    ...
    // }
        ...
        var valTypeFamiliar = getStorage64('liveInHouse');

        if (familiar_ID.length >= 10) {
          var dataRegistryUser = {
            "name": valInputName,
          ...
          setStorage64('registryGender', valInputGender); //console.log('familiar')

          sendRegistryFamilyFirst(dataRegistryUser);
        } else {
          var _dataRegistryUser = {
            "name": valInputName,
            "paternal": valInputPaternal,
            "maternal": valInputMaternal,
            "email": valInputEmail,
          ...
          setStorage64('registryFormFirst', _dataRegistryUser);
          setStorage64('registryGender', valInputGender); //console.log('normal')

          sendRegistryFirst(_dataRegistryUser);
        }
      }
  ...
  var validateRegistryFormMiddle = function validateRegistryFormMiddle() {
    //debugger
    var valInputPregnant = $('.pregnantType [name="pregnantReg"]:checked').val();
    var valInputPregnantValidate = $('.pregnantType [name="pregnantReg"]:checked').length;
    var valInputDiseases = $('.arrayDiseases [type="checkbox"]:checked').length;
    var genero = getStorage64('registryGender');
    var dataRegistryDiseases = getStorage64('arrayDiseases');
  ...
  var validateRegistryFormMiddleIMC = function validateRegistryFormMiddleIMC() {
    var valInputImcPesoReg = $('[name="imcPesoReg"]').val();
    var valInputImcAlturaReg = $('[name="imcAlturaReg"]').val();
    ...
    */
      ...
      */
          ...
          setStorage64('registryFormMiddleIMC', dataRegistryIMC); //console.log(dataRegistryIMC)

          sendRegistryMiddleIMC(dataRegistryIMC);
        }
  };

  var validateRegistryFormLast = function validateRegistryFormLast() {
    var familiar_ID = getStorage64('userRedisParentT');
    var valInputEmpresa = $('[name="selecEmpresaReg"]').val();
    var valInputArea = $('[name="selecAreaReg"]').val();
    var valInputTelCel = $('[name="telefonoCeluilarReg"]').val();
    var valInputFamiliar = $('[name="nombreFamiliarReg"]').val();
    var valInputTelEmerg = $('[name="telefonoEmergenciaReg"]').val();
    var valInputTelWork = '';
    ...
    if (familiar_ID.length >= 10) {
      if (valInputTelCel === '' || valInputTelCel === undefined || valInputTelCel === null) {
        ...
        var dataRegistryCompany = {
          "cell_phone": valInputTelCel,
          "emergency_phone": valInputTelEmerg,
          "emergency_contact": valInputFamiliar
        };
        setStorage64('registryFormLast', dataRegistryCompany); // console.log('familiar')
      ...
      if (valInputEmpresa === '' || valInputEmpresa === undefined || valInputEmpresa === null) {
        ...
        setStorage64('registryFormLast', _dataRegistryCompany); // console.log('normal')
        // console.log(dataRegistryCompany)

        sendRegistryLast(_dataRegistryCompany);
      }
    }
  };

  var validateMonitoringFormFirst = function validateMonitoringFormFirst() {
    //debugger
    var valInputTemperatura = $('[name="selecTemp"]').val();
    var valInputOximetry = $('[name="idOximetry"]').val();
    var valInputBreatheProblem = $('[name="breatheProblem"]:checked').val();
    var dataRegistrySymptoms = $('.arraySymptoms [type="checkbox"]:checked').length;
    ...
    if (valInputTemperatura === '' || valInputTemperatura === undefined || valInputTemperatura === null) {
      ...
      if (valInputBreatheProblem === "7") {
        ...
        var positionA = BreatheProblem.indexOf(7);

        if (positionA == -1) {
          BreatheProblem.push(7);
        }

        console.log('BreatheProblem2 7');
        console.log(BreatheProblem);
        dataMonitoringUser = {
          "symptoms": BreatheProblem,
          "temperature": valInputTemperatura,
        ...
        var _positionA = BreatheProblem.indexOf(7); // No borrar arreglo de síntomas


        if (_positionA !== -1) {
          BreatheProblem.splice(_positionA, 1);
        }
  ...
  var validateMonitoringFormLast = function validateMonitoringFormLast() {
    var btnIsolationActive = $('.forTwo.isolation .btn.secundario.active').length;
    var hayCuarentena = getStorage64('ifQuarantine');
    var valInputIsolation = $('[name="isolation"]:checked').val();
    var valInputWhereIsolation = $('[name="whereIsolation"]:checked').val();
    var valInputWhyIsolation = $('[name="whyIsolation"]').val();
    ...
    if (btnIsolationActive >= 1) {
      if (hayCuarentena === 'yes') {
        ...
        }, 1000); // $('.registryMonitoring .card.thanksMonitoringCaseOne').removeClass('hidden')
      }
    } else {
  ...
  var sendRecoveryPass = function sendRecoveryPass(email) {
    addLoader();
    axiosPasswords(email);
  };

  var sendUpdatePass = function sendUpdatePass(tok) {
    addLoader();
    axiosPassUpdate(tok);
  };

  var sendLogin = function sendLogin(data) {
  ...
  var sendMyAccount = function sendMyAccount() {
    /* console.log('as') */
  ...
  var sendUserProfile = function sendUserProfile() {
    /* console.log('asd') */
  ...
  var sendHistorial = function sendHistorial() {
    /* console.log('asd') */
  ...
  var sendActivitiesRegitrer = function sendActivitiesRegitrer() {
    redirectUrl('monitoring');
  };

  var sendClinicalProfile = function sendClinicalProfile() {
    redirectUrl('clinicalProfile');
  };

  var sendRegisterFamily = function sendRegisterFamily() {
    redirectUrl('registryFamilyData');
  };

  var sendNewNormal = function sendNewNormal() {
    redirectUrl('newNormal');
  };

  var sendEvalueFamily = function sendEvalueFamily(data, idUser) {
    addLoader();
    axiosParents(data, idUser);
  };

  var sendRegistryFamilyFirst = function sendRegistryFamilyFirst(data) {
    addLoader();
    axiosUsersFamily(data);
  };

  var sendRegistryFamilyLast = function sendRegistryFamilyLast(data) {
    addLoader();
    axiosContacts(data);
  };

  var sendRegistryFirst = function sendRegistryFirst(data) {
    addLoader();
    axiosUsers(data);
  };

  var sendRegistryMiddle = function sendRegistryMiddle(data) {
    addLoader();
    var diseases = {
      "diseases": data
    };
  ...
  var sendRegistryMiddleIMC = function sendRegistryMiddleIMC(data) {
    addLoader();
    axiosIMC(data);
  };

  var sendRegistryLast = function sendRegistryLast(data) {
    addLoader();
    axiosCompany(data);
  };

  var sendMonitoringFirst = function sendMonitoringFirst(data) {
  ...
  var sendMonitoringLast = function sendMonitoringLast(data) {
    axiosQuarantine(data);
    setTimeout(function () {
      redirectUrl('thankYouPage');
    }, 2000); // $('.monitoringModule .form.FormLast').addClass('hidden')
    // $('.monitoringModule .card.thanksMonitoringCaseOne').removeClass('hidden')
  };

  var sendUpdateCompany = function sendUpdateCompany(data) {
    addLoader();
  ...
  var addCompany = function addCompany(value) {
    var company = value;
    var i = 0;
  ...
  var addDepartment = function addDepartment(value) {
  ...
  var addDiseases = function addDiseases(value) {
    var diseases = value;
    var i = 0;
  ...
  var addSymptoms = function addSymptoms(value) {
    var symptoms = value;
    var i = 0;
  ...
  var addQuestions = function addQuestions(value) {// var questions = value
    // let i = 0
  ...
  var addReasons = function addReasons(value) {
    var reasons = value;
    var i = 0;
  ...
  var addFamilyRelationship = function addFamilyRelationship(value) {
  ...
  var preSelectedLastSyntoms = function preSelectedLastSyntoms(sym) {
    var symArray = sym;
    var fechaInicioSintomas = returnFormatDate(symArray.start_date);
    ...
    if (symArray.symptoms.length === 0) {
      ...
      var arr2 = [8];
      var difference = symArray.symptoms.filter(function (x) {
  ...
  var preSelectedLastQuar = function preSelectedLastQuar(quar) {
    var quarArray = quar;
    var reasonText = quarArray.reason;
    var reasonDate = quarArray.start_date;
    var fechaInicioCuarentena = returnFormatDate(reasonDate);
  ...
  var preSelectedCompany = function preSelectedCompany(quar) {
    var dataCompanyCont = getStorage64('dataCompanyCont');
    var departament = dataCompanyCont.departamento.id;
    var company = dataCompanyCont.empresa.id;
  ...
  var axiosListDiseases = function axiosListDiseases() {
    var config = {
      metodo: 'get',
  ...
  var axiosListSymptoms = function axiosListSymptoms() {
    var config = {
      metodo: 'get',
  ...
  var axiosListQuestions = function axiosListQuestions() {
    var config = {
      metodo: 'get',
  ...
  var axiosListReasons = function axiosListReasons() {
    var config = {
      metodo: 'get',
  ...
  var axiosListRelatives = function axiosListRelatives() {
    var config = {
      metodo: 'get',
  ...
  var axiosDataUser = function axiosDataUser() {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var config = {
      metodo: 'get',
  ...
  var axiosDataCompany = function axiosDataCompany() {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var config = {
      metodo: 'get',
  ...
  var axiosDataIMC = function axiosDataIMC() {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var config = {
      metodo: 'get',
  ...
  var axiosDataDiseases = function axiosDataDiseases() {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var config = {
      metodo: 'get',
  ...
  var axiosCatCompany = function axiosCatCompany() {
    var config = {
      metodo: 'get',
  ...
  var axiosCatDepartment = function axiosCatDepartment() {
    var config = {
      metodo: 'get',
  ...
  var axiosPreChargeSyntoms = function axiosPreChargeSyntoms() {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var config = {
      metodo: 'get',
  ...
  var axiosPreChargeQuarantine = function axiosPreChargeQuarantine() {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var config = {
      metodo: 'get',
    ...
    axios({
      ...
      if (error.message == 'Network Error') {
        ...
        addLoader('false'); //console.log(error.request.responseText)
      }
  ...
  var axiosCode = function axiosCode() {
    /*const config = {
    	metodo: 'get',
  ...
  var axiosVaidateReddis = function axiosVaidateReddis() {
    var dataActivate = getStorage64('userRedisT');
    var config = {
      metodo: 'get',
    ...
    axios({
      ...
      if (error.message == 'Network Error') {
        addLoader('false');
        toast('Error de conexión');
      } else if (error.request) {//addLoader('false')
      ...
      if (error.response.status === 401) {
        ...
        console.error(error.response); //request500()
      } else {
        console.error(error.response.status);
        console.error(error.response);
      }
  ...
  var axiosCompanyUpdate = function axiosCompanyUpdate(dataCompanyUpdate) {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
  ...
  var axiosParents = function axiosParents(dataParents, userID) {
    var user_ID = userID;
    var config = {
      metodo: 'post',
    ...
    axios({
      ...
      if (error.response.status === 400) {
        ...
        toast(error.response.data.message); //toast('Datos de usuario no válidos');
  ...
  var axiosUsersFamily = function axiosUsersFamily(dataUsers) {
    var familiar_ID = getStorage64('userRedisParentT');
    var config = {
      metodo: 'post',
  ...
  var axiosUsers = function axiosUsers(dataUsers) {
    var config = {
      metodo: 'post',
  ...
  var axiosDiseases = function axiosDiseases(dataDiseases) {
    var dataActivate = getStorage64('userRedisT');
    var userRegisterRelatives = getStorage64('userRegisterRelatives');
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
  ...
  var axiosIMC = function axiosIMC(dataIMC) {
    var dataActivate = getStorage64('userRedisT');
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var userRegisterRelatives = getStorage64('userRegisterRelatives');
    ...
    axios({
      ...
      if (res.status === 202) {
        ...
        if (userRegisterRelatives == "true") {
          ...
          setStorage64('dataImcCont', _updateIMC);
          updateIMCData();
        } else {
          sendIMCData();
        }
  ...
  var axiosCompany = function axiosCompany(dataCompany) {
    var dataActivate = getStorage64('userRedisT');
    var config = {
      metodo: 'post',
  ...
  var axiosContacts = function axiosContacts(dataContacts) {
    var dataActivate = getStorage64('userRedisT');
    var config = {
      metodo: 'post',
  ...
  var axiosSymptoms = function axiosSymptoms(dataSymptoms) {
    var dataActivate = getStorage64('userRedisT');
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var userRegisterRelatives = getStorage64('userRegisterRelatives');
  ...
  var axiosQuarantine = function axiosQuarantine(dataQuarantine) {
    var dataActivate = getStorage64('userRedisT');
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var userRegisterRelatives = getStorage64('userRegisterRelatives');
    ...
    axios({
      ...
      if (res.status === 202) {
        ...
        getStorage64('quarResp', dataQuarantine); //sessionUserActive('true')
      ...
      if (error.response.status === 401) {
        request401(); //sessionUserActive('true')
      } else if (error.response.status === 404) {
        console.error(error.response);
        request404();
      } else if (error.response.status === 440) {
        ...
        console.error(error.response); //sessionUserActive('true')
  ...
  var axiosQuarantineDel = function axiosQuarantineDel() {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var config = {
      metodo: 'delete',
    ...
    axios({
      ...
      if (error.response.status === 401) {
        ...
        console.error(error.response);
        request404();
      } else if (error.response.status === 405) {} else if (error.response.status === 440) {
        request440();
      } else if (error.response.status === 500) {
        console.error(error.response); //sessionUserActive('true')
  ...
  var axiosLogin = function axiosLogin(dataLogin) {
    var config = {
      metodo: 'post',
    ...
    axios({
      ...
      if (res.status === 200) {
        ...
        var regSuccessUserName = res.data.user_name; //setStorage64('userRedisT', regSuccessUser)
        ...
        sessionUserActive();
        request202();
        redirectUrl('myAccount'); //location.href = 'monitoring.html'
      }
    })["catch"](function (error) {
      if (error.message == 'Network Error') {
        addLoader('false');
  ...
  var axiosPasswords = function axiosPasswords(dataPassword) {
    var config = {
      metodo: 'post',
  ...
  var axiosPassUpdate = function axiosPassUpdate(dataUpPass) {
    var config = {
      metodo: 'put',
      url: BASE_API + 'covid-19/v1/users/passwords',
      cred: false,
  ...
  var axiosActivate = function axiosActivate() {
    var dataActivate = getStorage64('userRedisT');
    var config = {
      metodo: 'post',
  ...
  var axiosLogout = function axiosLogout() {
    var appT = getStorage64('userAppT');
    var appU = getStorage64('userAppU');
    var config = {
      metodo: 'get',
  ...
  var getAxios = function getAxios(endpoint) {
    var appT = getStorage64('userAppT');
    var config = {
      metodo: 'get',
      url: endpoint,
  ...
  var postAxios = function postAxios(endpoint, dataa) {
    var appT = getStorage64('userAppT');
    var config = {
      metodo: 'post',
      url: endpoint,
  ...
  var thanYouResult = function thanYouResult() {
    var appU = getStorage64('userAppU');
    var user = {
      baseBasal: 0,
      symptoms: [],
    ...
    getAxios("".concat(BASE_API, "covid-19/v2/users/").concat(appU, "/basal-risk")).then(function (data) {
      user.baseBasal = data.data.valor;
      getAxios("".concat(BASE_API, "covid-19/v1/users/").concat(appU, "/symptoms")).then(function (data) {
  ...
  var calculateManually = function calculateManually() {
    ...
    console.log(tUser.baseBasal, tUser.symptoms, tUser.temperature, arrayDiases.length, age);
  ...
  var assignRiskGroupAllocation = function assignRiskGroupAllocation(risk) {
    var riskGroupAllocation = [{
      points: 10,
      text: 'Basal bajo sin síntomas',
      "class": "resultCardOne",
      color: 'azul'
    }, // * Azul
    {
      points: 11,
      text: 'Basal bajo con riesgo leve',
      "class": "resultCardTwo",
      color: 'verde'
    }, // - Verde
    {
      points: 12,
      text: 'Basal bajo con riesgo moderado',
      "class": "resultCardThree",
      color: 'amarillo'
    }, // : Amarillo
    {
      points: 13,
      text: 'Basal bajo con riesgo grave',
      "class": "resultCardFour",
      color: 'rojo'
    }, // + Rojo
    {
      points: 20,
      text: 'Basal medio sin síntomas',
      "class": "resultCardTwo",
      color: 'verde'
    }, // - Verde
    {
      points: 21,
      text: 'Basal medio con riesgo leve',
      "class": "resultCardThree",
      color: 'amarillo'
    }, // : Amarillo
    {
      points: 22,
      text: 'Basal medio con riesgo moderado',
      "class": "resultCardThree",
      color: 'amarillo'
    }, // : Amarillo
    {
      points: 23,
      text: 'Basal medio con riesgo grave',
      "class": "resultCardFour",
      color: 'rojo'
    }, // + Rojo
    {
      points: 30,
      text: 'Basal alto sin síntomas',
      "class": "resultCardTwo",
      color: 'verde'
    }, // - Verde
    {
      points: 31,
      text: 'Basal alto con riesgo leve',
      "class": "resultCardThree",
      color: 'amarillo'
    }, // : Amarillo
    {
      points: 32,
      text: 'Basal alto con riesgo moderado',
      "class": "resultCardFour",
      color: 'rojo'
    }, // + Rojo
    {
      points: 33,
      text: 'Basal alto con riesgo grave',
      "class": "resultCardFour",
      color: 'rojo'
    } // + Rojo	
    ];
    ...
    if (element) {
      var appU = getStorage64('userAppU');
      postAxios("".concat(BASE_API, "covid-19/v2/users/").concat(appU, "/risk"), {
        "color": element.color,
  ...
  var calculateSumRisks = function calculateSumRisks(user) {
    var pointsSymptoms = [{
      symptomsIds: [1, 4],
      points: 2,
      cumulative: true
  ...
  var sendNotificationToRegisterFamily = function sendNotificationToRegisterFamily() {
    var tokenRedis = getStorage64('userRedisT');
    var appU = getStorage64('userAppU');
    console.log(tokenRedis);
    console.log(appU);
    postAxios("".concat(BASE_API, "covid-19/v2/users/").concat(appU, "/relatives/notification"), {
  ...
  var dataHistoric = {
    ...
    data: {},
    init: true,
    callService: true // historic_user: {},
    // historic_rela: {},

  };

  var historicPage = function historicPage() {
    getCallServiceHistoric();
    $(window).scrollTop();
  };

  var getCallServiceHistoric = function getCallServiceHistoric() {
    var SHOWN = 20;
    var appU = getStorage64('userAppU');
    var page = parseInt($('.historyList > div.historyItem').length / SHOWN) + 1;
    getAxios("".concat(BASE_API, "covid-19/v2/users/").concat(appU, "/historic?page=").concat(page)).then(function (data) {
      setDataHistoric(data.data);
    });
  };

  var setDataHistoric = function setDataHistoric(value) {
    var dates = JSON.parse(JSON.stringify(dataHistoric.dates));
    var users = JSON.parse(JSON.stringify(dataHistoric.users));
    var useID = []; // let historic_user = []
    // let historic_rela = []
    ...
    value.relatives.map(function (item_user) {
    ...
    value.historic.map(function (item_historic) {
      if (dates.includes(item_historic.date) == false) dates.push(item_historic.date);
    });
    dataHistoric.dates = _toConsumableArray(dates);
    dataHistoric.users = _toConsumableArray(users);

    if (dataHistoric.init) {
      dataHistoric.data = value;
    } else {
      dataHistoric.data.historic = [].concat(_toConsumableArray(dataHistoric.data.historic), _toConsumableArray(value.historic));
    }
  ...
  var paintFilterHistoric = function paintFilterHistoric() {
    dataHistoric.dates.map(function (item, key) {
    ...
    dataHistoric.users.map(function (item, key) {
      if ($('#selectFilterHistory option[value="' + key + '"]').length == 0) {
        if (dataHistoric.init) if (key == 0) $('[name="selectFilterHistory"]').append('<option selected value="' + -1 + '">' + 'Todos' + '</option>');
        $('[name="selectFilterHistory"]').append('<option value="' + key + '">' + item.user_name + '</option>');
      }
    });
  };

  var actionButtonFilters = function actionButtonFilters() {
    var date_selected = $('#selectDateHistory').val();
    var name_selected = $('#selectFilterHistory').val();
    ...
    if (dataHistoric.init) {
      ...
      if (dataHistoric.callService == false && dataHistoric.init == false) {
        ...
        for (var index = page; index < dataHistoric.data.historic.length; index++) {
          historic.push(dataHistoric.data.historic[index]);
        }

        actionFilters(date_selected, name_selected, dataHistoric.init, historic);
        dataHistoric.init == false;
      }
    }
  };

  var actionFilters = function actionFilters(date_selected, name_selected) {
    var removeData = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    var historic = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var relatives = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    ...
    if (date_selected < 0) {
      if (name_selected < 0) {
        ...
        relatives.map(function (item) {
          paintHistoricBody(item.historic, item);
        });
      } else if (name_selected == 0) {
        paintHistoricBody(historic, dataHistoric.users[name_selected]);
      } else {
        paintHistoricBody(relatives[name_selected - 1].historic, dataHistoric.users[name_selected]);
      }
    } else {
      if (name_selected < 0) {
        var historicFilter = historic.filter(function (item) {
          return date_selected == item.date;
        });
        paintHistoricBody(historicFilter, dataHistoric.data);
        relatives.map(function (item) {
          historic = item.historicFilter.filter(function (item) {
            return date_selected == item.date;
          });
          paintHistoricBody(historic, item);
        });
      } else if (name_selected == 0) {
        var _historicFilter = historic.filter(function (item) {
          return date_selected == item.date;
        });

        paintHistoricBody(_historicFilter, dataHistoric.users[name_selected]);
      } else {
        var _historicFilter2 = relatives[name_selected - 1].historic.filter(function (item) {
          return date_selected == item.date;
        });

        paintHistoricBody(_historicFilter2, dataHistoric.users[name_selected]);
      }
    }
  };

  var paintHistoricBody = function paintHistoricBody(historic, user) {
    var template = $('.historyList > div.historyItems').html();
    var container = $('.historyList > div.historyItems');
    historic.map(function (item) {
      var data = template.supplant({
        user_name: user.user_name,
        temperature: item.temperature,
        symptoms: item.symptoms ? 'Con síntomas' : 'Sin síntomas',
        quarantine: item.quarantine ? 'SI' : 'NO',
  ...
  var formatDate = function formatDate(value) {
    ...
    return "".concat(date[2], " de ").concat(months[parseInt(date[1])], " de ").concat(date[0]);
  };
  ...
  $('input[name="fechaNacimientoReg"]').attr({
    'max': dateMinBirthady
  });
  ...
  $('.problemsBreathe').on('click', function () {
  ...
  if (window.location.pathname.indexOf('/home') !== -1) {
    ...
    if (loginIn !== "true") {//redirectUrl('home')
    } else {
      redirectUrl('myAccount');
    }
    ...
    if (loginIn !== "true") {
      ...
      axiosDataIMC();
      axiosDataDiseases();
      $('.userProfileNavBar').text(firstName); //console.log(a)
    }
    ...
    var loginIn = getStorage64('userLoginSession');
    var name = getStorage64('userAppN').split(' '); // deleteStorage64('userRedisParentT')
    // deleteStorage64('liveInHouse')
    ...
    if (loginIn !== "true" || userRegisterRelatives == "true") {//redirectUrl('home')
    } else {
